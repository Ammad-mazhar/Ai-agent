...
// MANUAL OVERRIDE: This checks your Railway 'AGENT_STATUS' variable first.
// If the variable is missing, it defaults to 'true'.
let isAgentEnabled = process.env.AGENT_STATUS !== 'OFF';

console.log(`🚀 System Boot: Agent is currently ${isAgentEnabled ? 'ACTIVE' : 'SLEEPING'}`);
